...
func (r *Repository) GetDraftOrders(creatorID int) ([]Order, uint, error) {
	...
	q := r.db.Table("records_stages ao").
		Select("o.id, o.title, o.risk_class, o.code, o.icon, o.pressure, o.image_key, o.description, o.sys_from, o.sys_to, o.dia_from, o.dia_to, ao.quantity, ao.doctor_comment").
